...
// Project: https://github.com/dfa1234/cordova-plugin-push
...
declare namespace PhonegapPluginPush {
	...
	interface InitOptions {
		...
		ios?: {
			 ...
			 * Action Buttons on iOS - https://github.com/dfa1234/cordova-plugin-push/blob/master/docs/PAYLOAD.md#action-buttons-1
			 */
